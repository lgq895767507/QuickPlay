...
Java_com_example_quickplayer_QuickPlayer_native_1prepare(JNIEnv *env, jobject instance,
                                                         jstring dataSource_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_quickplayer_QuickPlayer_native_1start(JNIEnv *env, jobject instance) {
    //正是进入播放状态
    if (wangYiFFmpeg) {
        wangYiFFmpeg->start();
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_quickplayer_QuickPlayer_native_1set_1surface(JNIEnv *env, jobject instance,
                                                              jobject surface) {
